...
for i = startVer:endVer
    verDir{i} = sprintf('KN_PredictionsV%d', i);
end
...
for v = 1:length(verDir)
    for frame = startFrame:endFrame
        ...
        prFilepath_DNN = ['~/Documents/MAI Research/Videos/Knight/' ...
            'DNN_Knight/', verDir{v}, '/KN_PredictedMask%04d.tiff'];
